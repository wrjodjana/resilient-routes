...
# python multitask_batch_only_reg_dev.py --model_idx=8 --batch_size=512 --dataset_name='data' --percentage=$percentage

# python multitask_batch_only_reg_dev.py --model_idx=9 --batch_size=512 --dataset_name='data' --percentage=$percentage

# python multitask_batch_only_reg_dev.py --model_idx=10 --batch_size=512 --dataset_name='data' --percentage=$percentage
