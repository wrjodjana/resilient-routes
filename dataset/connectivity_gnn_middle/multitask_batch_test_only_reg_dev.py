...
for target_node_id in test_targets:
    if target_node_id in train_targets:
        val_dir = './{}/data_{}_v3'.format(dataset_name, target_node_id)    # path to load different data
        img_dir = './{}/img_reg_{}_v3'.format(imageset_name, target_node_id)  # path to save the prediction
