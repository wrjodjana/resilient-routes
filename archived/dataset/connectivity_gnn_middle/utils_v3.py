# v3: add more node and edge to the graph (include half of bay area)
...
def plot_reg_graph(img_dir, img_idx, edge_list, values, node_ID, edge_labels, plot_norm, img_name):
    ...
    nx.draw(G, pos, cmap=plt.cm.Blues, node_color=values, \
            with_labels=True, node_size=1200, font_color='red',font_size=16, font_weight='bold', width=2, vmin=plot_norm.vmin, vmax=plot_norm.vmax*1.2)
