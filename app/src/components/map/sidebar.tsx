...
const Sidebar = () => {
  return (
    <div className="w-1/4 p-4 shadow bg-lightBlue">
      <h2 className="text-xl font-bold mb-4 text-cyan mt-3">SIDEBAR</h2>
      <div className="mb-4">
        <label className="block mb-2 font-bold font-figtree">Select Scenario</label>
        <select className="w-150 px-2 py-1 border border-gray-300 rounded font-figtree">
          <option value="scenario1">Show on Edge Level</option>
          <option value="scenario2">Show on Node Level</option>
          <option value="scenario3">Flood Levels</option>
        </select>
      </div>
      <div className="mb-4">
        ...
        <form>
          <div className="mb-2">
            ...
            <input type="text" className="w-75 px-2 py-1 border border-gray-300 rounded font-figtree" />
          </div>
          <div className="mb-2">
            <label className="block mb-1 font-bold font-figtree">End Place</label>
            <input type="text" className="w-75 px-2 py-1 border border-gray-300 rounded font-figtree" />
          </div>
          <button type="submit" className="px-4 py-2 bg-blue-500 text-white rounded font-figtree">
            Run Scenario
          </button>
        </form>
      </div>
