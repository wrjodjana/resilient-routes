...
export const TrafficMap = () => {
  ...
  useEffect(() => {
    if (selectedNodeId) {
      fetch(`https://3.19.74.180:5000/data/matrix/${selectedMap}`)
  ...
  useEffect(() => {
    if (flowScenarios || capacityScenarios || ratioScenarios) {
      fetch(`https://3.19.74.180:5000/data/traffic/${selectedMap}`)
        .then((response) => response.json())
  ...
  useEffect(() => {
    if (GNNFlowScenarios || GNNRatioScenarios) {
      fetch(`https://3.19.74.180:5000/data/traffic-earthquake/${selectedEarthquakeType}/${selectedGNNMap}`)
        .then((response) => response.json())
